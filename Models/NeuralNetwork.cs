...
namespace NeuralNetwork
{
    ...
    {
        private ActivationType ActiovationType { get; set; }
        ...
        public NeuralNetwork(int inputVectorSize, int hidLayerSize, int outLayerSize, double learningRate, ActivationType activationType)
        {
            this.InputVectorSize = inputVectorSize;
            this.HidLayerSize = hidLayerSize;
            this.OutLayerSize = outLayerSize;
            this.LearningRate = learningRate;
            this.ActiovationType = activationType;
        }
